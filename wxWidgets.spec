...
%post	-n wxBase-unicode -p /usr/sbin/ldconfig
%postun -n wxBase-unicode -p /usr/sbin/ldconfig

%post	-n wxGTK-unicode -p /usr/sbin/ldconfig
%postun -n wxGTK-unicode -p /usr/sbin/ldconfig
